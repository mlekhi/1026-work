...
print('--------------- Test 6 - findAllCityFlights() ---------------')
...
print('--------------- Test 7 - findAllCountryFlights() ---------------')
...
print('--------------- Test 8 - findFlightBetween() ---------------')
...
print('--------------- Test 9 - findFlightBetween() ---------------')
...
print('--------------- Test 10 - findReturnFlight() ---------------')
...
print('--------------- Test 11 - findFlightsAcross() ---------------')
avi.loadData("airports.txt", flightsFileName, "countries.txt")
